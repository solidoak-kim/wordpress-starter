...
<?php if(is_single()) : global $post; setup_postdata($post); ?>
	...
	<meta property="og:image" content="<?php echo _popmarketGetImageURL( $post-ID ); ?>" />
	<meta property="og:description" content="<?php echo _psExcerpt(20, false, '', true); ?> " />
<?php else : ?>
...
<link rel="shortcut icon" href="<?php bloginfo( 'template_directory' ); ?>/inc/images/favicon.ico" type="image/x-icon" />	
...
<body <?php _popmarketIOSClass( body_class() ); ?> >
